...
export const hoverUpdate = ({ grid, row, col, rotated, type }) => {
...
export const getOpponentShipIdx = (opponent, row, col) => {
  let idx = 0;
...
export const placeMove = ({ grid, row, col, rotated, player, opponent }) => {
